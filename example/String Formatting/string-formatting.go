...
func main() {
	p := point{1, 2}
	// Go offers several printing verbs. The %v verb is for general values.
	...
	fmt.Printf("|%-6s|%-6s|\n", "foo", "b")
	// So far we’ve seen Printf, which prints to an io.Writer. Sprintf formats and returns a string without printing it anywhere.
